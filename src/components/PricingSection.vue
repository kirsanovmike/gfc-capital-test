<template>
  <section id="benefits" class="pb-8">
    <v-container fluid id="benefits" class="mt-n4">
      <v-row align="center" justify="center">
        <v-col class="px-0" cols="10">
          <h1 class="font-weight-light display-2 mt-6">Benefits</h1>
          <h1 class="font-weight-light display-1 mb-3 mt-2">
            Your profits
          </h1>
          <v-row class="mt-6 px-0" align="center" justify="space-around">
...
export default {
  data: () => ({
    ...
    features: [
      {
        img: require("@/assets/img/exchange (1).png"),
        title: "Replenish turnover",
        text: "Turnover increases, sales volume increases",
      },
      {
        img: require("@/assets/img/profits big.png"),
        title: "Profit growth",
